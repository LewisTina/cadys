                ...
                `}>
                    ...
                    <div className="">
                        ...
                        <div className="my-10">
                            ...
                            <SideBarLink path={"/propositions"} label={"proposition"} icon={"flash_on"} notification notificationCount={10}/>
                            <SideBarLink path={"/missions"} label={"mission_in_progress"} icon={"business_center"}/>
                            <SideBarLink path={"/disponibility"} label={"disponibility"} icon={"calendar_month"}/>
                        </div>
                        ...
                        <div className="my-10">
                            ...
                            <SideBarLink path={"/history"} label={"history"} icon={"history"}/>
                            <SideBarLink path={"/news"} label={"cadys_news"} icon={"notifications"} notification notificationCount={100}/>
                        </div>
                    </div>

                    <div className="w-full">
                        <div className="">
                            <SideBarLink path={"/settings"} label={"settings"} icon={"settings"}/>
                            <SideBarLink path={"/support"} label={"contact_support"} icon={"support_agent"}/>
                        </div>
